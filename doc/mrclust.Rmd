...
```
There are 5 variants assigned to cluster 1 with an allocation probability in the range (0.9,1), there is 1 variant with an allocation prbability in the range (0.8, 0.9) and no variants with allocation probabilities in the range (0.7,0.8). We can single out the variants with the largest allocation probabilities by typing
